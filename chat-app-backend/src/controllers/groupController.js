...
const CreateGroup = async(req, res)=>{
    const {groupName, groupProfilePic, groupMember, admins, superAdmin} = req.body;
    ...
    if (groupProfilePic) {
      ...
      uploadedUrl = uploaded.secure_url;
        ...
        const newGroup = await Group.create({
            groupName, groupProfilePic:uploadedUrl, groupMember, admins, superAdmin
        })
...
const GetAllGroups = async (req, res) => {
    try {
      ...
      const allGroups = await Group.find({
        ...
        .populate("groupMember", "username profilePic")
        .populate("admins", "username profilePic")
        .populate("superAdmin", "username profilePic");
...
const SendGroupMessage = async (req, res)=>{
    ...
    try{
        ...
        const populateMessage = await saveMessage.populate("sender", "_id username profilePic");
...
module.exports = {CreateGroup, GetAllGroups, SendGroupMessage, GetGroupMessages}